      ...
      <main className="flex-grow flex flex-col items-center justify-center px-6 pb-24">
        ...
        <div className="w-full max-w-md bg-[var(--color-surface-container-highest)] rounded-[2rem] p-8 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="w-full grid grid-cols-3 gap-4 mt-8 relative z-10">
            <button
              onClick={onDecrement}
              className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl bg-[var(--color-secondary-container)] bg-opacity-20 text-[var(--color-error)] hover:bg-opacity-30 transition-all active:scale-95 duration-150 group"
            >
            ...
            <button
              onClick={onIncrement}
              className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl bg-[var(--color-primary-container)] bg-opacity-20 text-[var(--color-primary)] hover:bg-opacity-30 transition-all active:scale-95 duration-150 group"
            >
