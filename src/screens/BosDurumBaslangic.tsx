...
export function BosDurumBaslangic(props: BosDurumBaslangicProps) {
  const { count, target, onIncrement, onDecrement, onReset, onNavigate } = props;
    ...
    <>
      ...
      <header className="w-full top-0 sticky z-50 bg-[#131318] flex justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2 rounded-full hover:bg-[#1b1b20] transition-colors text-[#e4e1e9] scale-95 duration-200 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary"
          >
        ...
        <section className="w-full max-w-md flex flex-col items-center">
          ...
          <div className="w-full flex justify-between items-end mb-8 px-2">
            ...
            <div className="text-right">
              ...
              <span className="text-on-surface font-semibold text-sm tracking-wide">{target}</span>
            </div>
          </div>
          ...
          <div className="w-full grid grid-cols-2 gap-4 mt-8">
            ...
            <button
              onClick={onDecrement}
              className="group flex flex-col items-center justify-center p-8 bg-surface-container-low rounded-xl active:scale-95 transition-all duration-150 border border-outline-variant/5 cursor-pointer"
            >
            ...
            <button
              onClick={onIncrement}
              className="group flex flex-col items-center justify-center p-8 bg-gradient-to-br from-primary to-primary-container rounded-xl active:scale-95 transition-all duration-150 shadow-[0_10px_30px_rgba(75,226,119,0.2)] cursor-pointer"
            >
          ...
          <div className="w-full flex justify-end mt-6">
            <button
              onClick={onReset}
              className="flex items-center gap-3 px-6 py-3 bg-surface-container-low rounded-full hover:bg-surface-container-high transition-colors text-tertiary group cursor-pointer"
            >
        ...
        <div className="w-full max-w-4xl mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-container-low p-6 rounded-3xl flex items-center gap-4 border border-outline-variant/10">
            ...
            <div>
              ...
              <p className="text-on-surface font-headline text-xl">{formatDuration()}</p>
            </div>
          </div>
          <div className="bg-surface-container-low p-6 rounded-3xl flex items-center gap-4 border border-outline-variant/10">
      ...
      <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center py-3 px-4 bg-[#131318] z-50 rounded-t-xl border-t border-[#3d4a3d]/15 shadow-[0_-4px_20px_rgba(75,226,119,0.06)]">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center text-[#4be277] font-bold transition-all active:scale-90 duration-150 cursor-pointer"
        >
        ...
        <button
          ...
          className="flex flex-col items-center justify-center text-[#c0c7d7] opacity-60 hover:text-[#4be277] transition-all active:scale-90 duration-150 cursor-pointer"
        >
          <span className="material-symbols-outlined">history</span>
