...
export function AnaSayfa(props: AnaSayfaProps) {
  const { count, target, todayIncrease, onIncrement, onDecrement, onReset, onNavigate } = props;
      ...
      <header className="w-full top-0 sticky bg-[#131318] flex justify-between items-center px-6 py-4 w-full z-50">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="text-[#e4e1e9] hover:bg-[#1b1b20] transition-colors p-2 rounded-full active:scale-95 duration-200 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary"
          >
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-6 pb-24">
        ...
        <div className="w-full max-w-md bg-surface-container-highest rounded-[2rem] p-8 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="w-full grid grid-cols-3 gap-4 mt-8 relative z-10">
            ...
            <button
              onClick={onDecrement}
              className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl bg-secondary-container bg-opacity-20 text-error hover:bg-opacity-30 transition-all active:scale-95 duration-150 group cursor-pointer"
            >
            ...
            <button
              onClick={onReset}
              className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl bg-surface-container-low text-tertiary hover:bg-surface-variant transition-all active:scale-95 duration-150 group cursor-pointer"
            >
            ...
            <button
              onClick={onIncrement}
              className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl bg-primary-container bg-opacity-20 text-primary hover:bg-opacity-30 transition-all active:scale-95 duration-150 group cursor-pointer"
            >
